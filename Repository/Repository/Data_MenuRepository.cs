    ...
    public class Data_MenuRepository : GenericRepository<Data_Menu>, IData_MenuRepository
    {
        ...
        public List<Data_Menu> GetList()
        {
            ...
            try
            {
                ...
                l1.ChildMenus.Add(new Data_Menu() { MenuID = 4, Name = "Hiện trạng hoạt động (Layout 1)", ParentID = 1, OrderNo = 4, IsShowMenu = true, Url = "http://dvkt_v1.wdi/hien-trang-hoat-dong.html" });
                l1.ChildMenus.Add(new Data_Menu() { MenuID = 5, Name = "Hiện trạng hoạt động (Layout 2)", ParentID = 1, OrderNo = 5, IsShowMenu = true, Url = "http://dvkt_v1.wdi/hien-trang-hoat-dong-card.html" });
                ...
                l2.ChildMenus.Add(new Data_Menu() { MenuID = 66, Name = "Mã lỗi", ParentID = 62, OrderNo = 66, IsShowMenu = true, Url = "http://dvkt_v1.wdi/ma-loi.html" });
                l1.ChildMenus.Add(l2);
