    ...
    public static partial class StaticData
    {
        ...
        static StaticData()
        {
            try
            {
                ...
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 10, MachineName = "MÁY GÁ XOAY BÀN", MachineNameOrigin = "Bộ gá hàn dầm Model 50T-H BRUCO - HD 541 - 27/9/19 - Nam Weldcom - DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 11, MachineName = "MÁY GÁ HỘP DẠNG CỔNG XXZ15", MachineNameOrigin = "MÁY GÁ HỘP DẠNG CỔNG XXZ15", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 12, MachineName = "MÁY ĐÍNH GÁ DẦM H TỰ ĐỘNG.", MachineNameOrigin = "Máy ính gá dầm H tự ộng Medol BZJ -2000Plus - HD 523 - 26/9/19 - DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 13, MachineName = "MÁY GÁ TẤM XJZ 15", MachineNameOrigin = "MÁY GÁ TẤM XJZ 15", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 14, MachineName = "THIẾT BỊ LẬT DẦM XF 15 - SỐ 01", MachineNameOrigin = "Máy hàn dầm hộp trọn bộ-Jingfeng-ACBL-DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 15, MachineName = "THIẾT BỊ LẬT DẦM XF 15 - SỐ 02", MachineNameOrigin = "THIẾT BỊ LẬT DẦM XF 15 - SỐ 02", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 16, MachineName = "THIẾT BỊ LẬT DẦM XF 15 - SỐ 03", MachineNameOrigin = "THIẾT BỊ LẬT DẦM XF 15 - SỐ 03", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 17, MachineName = "THIẾT BỊ LẬT DẦM XF 15 - SỐ 04", MachineNameOrigin = "THIẾT BỊ LẬT DẦM XF 15 - SỐ 04", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 18, MachineName = "MÁY RÁP DẦM ZHOUXIANG - NGANG", MachineNameOrigin = "Máy ính gá dầm H tự ộng Model HZJ-2000", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 19, MachineName = "MÁY NẮN THẲNG CÁNH DẦM HẠNG NẶNG", MachineNameOrigin = "Máy nắn thẳng cánh dầm hạng nặng Model YJZ 80B - HD 526 - 26/9/19 - DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 20, MachineName = "MÁY NẮN THẲNG CÁNH DẦM HẠNG NẶNG", MachineNameOrigin = "Máy nắn thẳng cánh dầm hạng nặng Model Y80B - HD 526 - 26/9/19 - DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 21, MachineName = "MÁY HÀN CỔNG HẠNG NẶNG.", MachineNameOrigin = "", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 22, MachineName = "MÁY HÀN CỔNG HẠNG NẶNG.", MachineNameOrigin = "Máy hàn cổng thông minh hạng nặng - VCB02- 62.23.07/CTTC (7 năm)", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 23, MachineName = "MÁY HÀN DẦM CỘT, HÀN NỐI ỐNG", MachineNameOrigin = "Máy hàn cần cột, hàn nối ống CZM-8x6 - HD 459 - 24/10/19 - Cơ Khí Đồng Nai - DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 24, MachineName = "MÁY HÀN DẦM CỘT, HÀN NỐI ỐNG", MachineNameOrigin = "Máy hàn cần cột, hàn nối ống CZM-4x7 - HD 459 - 24/10/19 - Cơ Khí Đồng Nai - DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 25, MachineName = "MÁY HÀN CỔNG HẠNG NẶNG", MachineNameOrigin = "Máy hàn cổng hạng nặng model BTMZ-S3 (01 bộ) - HĐ số 013-19/HDMMTB/DDCI-NW-HD 23867 - 20/11/19-NAM WELDCOM-DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 26, MachineName = "MÁY HÀN CỔNG THÔNG MINH", MachineNameOrigin = "Máy hàn dầm ngang Model (Cổng hàn thông minh) HN0630-S1 - ACBL - DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 27, MachineName = "MÁY HÀN DẦM CỘT, HÀN NỐI ỐNG", MachineNameOrigin = "Máy hàn cần cột, hàn ống nối CZM-8x6 - HD 459 - 24/10/2019 - CK Đồng Nai - DDCI", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 28, MachineName = "MÁY HÀN CO2 DẠNG CỔNG XQHB-15  1 BỘ GỒM 4 NGUỒN CO2 OTC XD 500", MachineNameOrigin = "MÁY HÀN CO2 DẠNG CỔNG XQHB-15  1 BỘ GỒM 4 NGUỒN CO2 OTC XD 500", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 29, MachineName = "MÁY HÀN CO2 DẠNG CỔNG XQHB-15   1 BỘ GỒM 4 NGUỒN CO2 OTC XD 500", MachineNameOrigin = "MÁY HÀN CO2 DẠNG CỔNG XQHB-15   1 BỘ GỒM 4 NGUỒN CO2 OTC XD 500", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 30, MachineName = "MÁY HÀN ĐIỆN XỈ DẠNG CỔNG XZHB-15", MachineNameOrigin = "MÁY HÀN ĐIỆN XỈ DẠNG CỔNG XZHB-15", MachineGroupID = 2, MachineGroupName = "DCTH" });
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 31, MachineName = "MÁY HÀN HỒ QUANG CHÌM DANG CỔNG XMHB 15", MachineNameOrigin = "MÁY HÀN HỒ QUANG CHÌM DANG CỔNG XMHB 15", MachineGroupID = 2, MachineGroupName = "DCTH" });
                ...
                Data_Machine.Add(new Common.Data_Machine() { MachineID = 39, MachineName = "MÁY CẮT THỦY LỰC 12M YSD", MachineNameOrigin = "Máy cắt iều khiển CNC", MachineGroupID = 2, MachineGroupName = "DCTH" });
